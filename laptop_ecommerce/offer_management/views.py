...
class CategoryOfferView(View):
    def get(self, request):
        ...
        return render(request,'admin_templates/evara-backend/page-category-offer-mng.html', context)
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            category_offer = CategoryOffer.objects.create(offer_name=offer_name, expire_date=expire_date, category=category, discount_rate=discount_rate, is_active=is_active)
            category_offer.save()
...
class CategoryEditView(View):
    def get(self, request, pk):
        ...
        try:
            deleted_id = CategoryOffer.objects.values('id').filter(pk=pk, is_active=False)
...
class ProductOfferView(View):
    def get(self, request):
        ...
        return render(request,'admin_templates/evara-backend/page-product-offer-mng.html', context)
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            product_offer = ProductOffer.objects.create(offer_name=offer_name, expire_date=expire_date, products=products, discount_rate=discount_rate, is_active=is_active)
            product_offer.save()
...
class ProductEditView(View):
    def get(self, request, pk):
        ...
        try:
            deleted_id = ProductOffer.objects.values('id').filter(pk=pk, is_active=False)
